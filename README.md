...
- [VK_EXT_raster_multisample](https://github.com/Jonathan-Weinstein/vktest/blob/main/VK_EXT_raster_multisample.md)（等价于 [Target Independent Rasterization](https://microsoft.github.io/DirectX-Specs/d3d/archive/D3D11_3_FunctionalSpec.htm#TIR)）
- [VK_EXT_line_rasterization](https://registry.khronos.org/VulkanSC/specs/1.0-extensions/man/html/VK_EXT_line_rasterization.html)
...
- [VK_EXT_shader_tile_image](https://github.com/KhronosGroup/Vulkan-Docs/blob/main/proposals/VK_EXT_shader_tile_image.adoc)
...
- [VK_EXT_shader_viewport_index_layer](https://docs.vulkan.org/refpages/latest/refpages/source/VK_EXT_shader_viewport_index_layer.html)
...
- [Direct3D 12 Hardware Feature Levels](https://learn.microsoft.com/en-us/windows/win32/direct3d12/hardware-feature-levels)
- [D3D12_FEATURE enumeration (d3d12.h)](https://learn.microsoft.com/en-us/windows/win32/api/d3d12/ne-d3d12-d3d12_feature)
- [D3D12DDICAPS_TYPE enumeration (d3d12umddi.h)](https://learn.microsoft.com/en-us/windows-hardware/drivers/ddi/d3d12umddi/ne-d3d12umddi-d3d12ddicaps_type)
...
- [Subresources (Direct3D 11 Graphics)](https://learn.microsoft.com/en-us/windows/win32/direct3d11/overviews-direct3d-11-resources-subresources)（关于初始化纹理数据可参考：[D3D11_SUBRESOURCE_DATA structure (d3d11.h)](https://learn.microsoft.com/en-us/windows/win32/api/d3d11/ns-d3d11-d3d11_subresource_data)）
...
- [GL_ARB_gpu_shader_int64](https://github.com/KhronosGroup/OpenGL-Registry/blob/main/extensions/ARB/ARB_gpu_shader_int64.txt)
...
- [GL_EXT_samplerless_texture_functions](https://github.com/KhronosGroup/GLSL/blob/main/extensions/ext/GL_EXT_samplerless_texture_functions.txt)
...
- [NVIDIA Nsight Visual Studio Code Edition](https://docs.nvidia.com/nsight-visual-studio-code-edition/latest/index.html)
...
- [GPUDirect Storage（GDS）技术解析](https://mp.weixin.qq.com/s?__biz=Mzk2NDEyMTM1Mg==&mid=2247488648&idx=1&sn=19ca56a2d3aa8d52f10a7190d3d63fec)
...
- [CS336 Lecture 5 — GPU](https://mp.weixin.qq.com/s?__biz=Mzg5MTE4NTY3NQ==&mid=2247489510&idx=1&sn=4d5cc021dafe1a64489be191a8fcac8e)
...
- [从“线程运算”到“内存调度”：Blackwell架构彻底改写GPU矩阵乘法规则](https://mp.weixin.qq.com/s?__biz=MjM5NTE3Nzk4MQ==&mid=2651250588&idx=1&sn=84c43020d69b677b1d35c81accd45d0d)
- [硬核拆解 | Nvidia GPU Cache Policy：从硬件设计到PTX指令的极致调优](https://mp.weixin.qq.com/s?__biz=MzkyNjAyNzE3MQ==&mid=2247489745&idx=1&sn=d1df3fbbd1b827ead831ab7c43583cc1)
...
- [RIGEL：逆向拆解 Apple M4 Max GPU 的 Metal 4.1 张量计算通路](https://mp.weixin.qq.com/s?__biz=MjM5NDczOTA4NQ==&mid=2447902692&idx=1&sn=6c546a2fd3f9fc3960e81c9b98e151f8)
- [苹果 M5 芯片揭秘：专属矩阵硬件登场，GPU 架构迎来颠覆性升级](https://mp.weixin.qq.com/s?__biz=MzIwMjc1NDc1Nw==&mid=2247484298&idx=1&sn=de722c1cd0512f381a240891e7e7da48)
...
- [登上GitHub趋势榜！纯C推理引擎让25GB内存也能运行GLM-5.2](https://mp.weixin.qq.com/s?__biz=MjM5ODExNDA2MA==&mid=2450016773&idx=1&sn=607831dd9bd266ce833ff568864677f9)
...
- [从手写DSP汇编到GPU算子（二）：TileLang与九齿实战，我的第一次并行编程](https://mp.weixin.qq.com/s?__biz=MzcwOTQzMDgyMA==&mid=2247483960&idx=1&sn=884e6200cfab47a87f1032d9cd1a8c6f)
- [Automatic Mixed Precision for Deep Learning](https://developer.nvidia.com/automatic-mixed-precision)
- [NVIDIA混合精度训练](https://developer.nvidia.com/automatic-mixed-precision)
- [pytorch笔记：自动混合精度（AMP）](https://blog.csdn.net/qq_40206371/article/details/139405388)
- [为什么BF16比FP16更受欢迎？LLM大模型精度（FP32、FP16、BF16、FP8）详解！](https://mp.weixin.qq.com/s?__biz=MzkzMTk5MTEwNw==&mid=2247488758&idx=1&sn=c69f69de4d61a5ae4d67303d429fa684)
...
- [AI Infra落地实战·第1篇：GPU调度](https://mp.weixin.qq.com/s?__biz=MzUzNzY4OTUyOA==&mid=2247484276&idx=1&sn=0fb1b30d1021f0ed0fa6569310996a2d)
...
- [CUDA Graph：怎样减少大量小 Kernel 的重复启动开销](https://mp.weixin.qq.com/s?__biz=MzkzMDExODgyNg==&mid=2247485306&idx=1&sn=d52d9d7a725460b7f066126ebd7a8972)
...
- [CUDA编译和Triton编译介绍](https://mp.weixin.qq.com/s?__biz=MzAxMDYyMDAwNw==&mid=2247483929&idx=1&sn=a082f7c6685f80bf6ea0a15ab95fc45a)
...
- [Imagination PowerVR Developer Documentation](https://docs.imgtec.com/html/index.html)
